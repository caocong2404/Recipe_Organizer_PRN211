namespace Recipe_Organizer_PRN211.Authentication
{
	partial class AdminProfie
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AdminProfie));
			label5 = new Label();
			...
			label5.Location = new Point(538, 27);
			label5.Name = "label5";
			...
			btnUpdate.Location = new Point(437, 375);
			...
			// txtLastname
			// 
			txtLastname.Location = new Point(539, 318);
			...
			txtWelcome.Location = new Point(24, 44);
			...
			pictureBox1.Location = new Point(143, 106);
			...
			// 
			editToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { formatToolStripMenuItem });
			...
			pictureBox2.Location = new Point(468, 76);
			pictureBox2.Name = "pictureBox2";
			pictureBox2.Size = new Size(282, 203);
